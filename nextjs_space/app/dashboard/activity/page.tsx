/**
 * STEP 24: Global Activity Log Page (Buyer View)
 * /dashboard/activity
 */
...
import { ChevronDown, ChevronUp, Loader2, Filter, Activity } from "lucide-react";
...
export default function GlobalActivityPage() {
  ...
  useEffect(() => {
    // Fetch RFPs for filter dropdown
  ...
  useEffect(() => {
    fetchLogs();
  }, [page, rfpId, eventType, actorRole, dateFrom, dateTo]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Global Activity Timeline</h1>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              <select
                value={rfpId}
                onChange={(e) => { setRfpId(e.target.value); setPage(1); }}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          {log.rfp && (
                            <Link href={`/dashboard/rfps/${log.rfpId}`}>
